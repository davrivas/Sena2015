Proceso Matrices_promedios_diagonal_iguales
	//Leer dos matrices 5x5 enteras y determinar si el promedio entero de los elementos que se encuentran en su diagonal está almacenado en ella. Mostrar en pantalla en qué posiciones exactas se encuentra dicho dato.
	...
	Si prom1=prom2 Entonces
		Escribir "Los promedio de las diagonales son iguales.";
	Sino
		Escribir "Los promedio de las diagonales son diferentes.";
	FinSi
FinProceso
